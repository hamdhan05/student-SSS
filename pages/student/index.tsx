  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-gray-600 dark:text-white text-lg">Loading...</div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto p-0 rounded-lg">
        {activeTab === 'academics' && (
          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-gray-600 dark:text-white">Academic Performance</h2>

            {student?.academics && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {student.academics.map((record: any) => (
                  <div key={record.subject} className="card p-6 bg-white dark:bg-black/40 border border-gray-200 dark:border-white/10 shadow-sm dark:shadow-none">
                    <h3 className="text-xl font-semibold text-gray-600 dark:text-white mb-4">{record.subject}</h3>
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-400">Test 1:</span>
                        <span className="text-gray-600 dark:text-white font-medium">{record.test1}/100</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-400">Test 2:</span>
                        <span className="text-gray-600 dark:text-white font-medium">{record.test2}/100</span>
                      </div>
                      <div className="flex justify-between border-t border-gray-100 dark:border-gray-700 pt-3">
                        <span className="text-gray-700 dark:text-gray-300 font-semibold">Average:</span>
                        <span className="text-gray-600 dark:text-white font-bold text-lg">
            ...
            {(!student?.academics || student.academics.length === 0) && (
              <div className="card p-8 text-center text-gray-500 dark:text-gray-400 bg-white dark:bg-black/40 border border-gray-200 dark:border-white/10">No academic records available</div>
            )}
          </div>
        )}
        ...
        {activeTab === 'timetable' && (
          <div className="card p-6 overflow-x-auto bg-white dark:bg-black/40 border border-gray-200 dark:border-white/10">
            <h2 className="text-3xl font-bold text-gray-600 dark:text-white mb-6">Weekly Timetable</h2>
                        ...
                        {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'].map((day, j) => {
                          ...
                          return (
                            <td key={day} className="px-6 py-4 whitespace-nowrap text-center border-r border-gray-200 dark:border-gray-700 last:border-r-0">
                              {isBreak ? (
                                <span className="text-gray-400 dark:text-gray-500 italic">Lunch Break</span>
                              ) : (
                                <div className="flex flex-col items-center text-gray-600 dark:text-white">
                                  <span className="font-bold">{subject}</span>
                                  <span className="text-xs text-gray-500 dark:text-gray-400 opacity-75">Room {101 + i}</span>
                                </div>
                              )}
                            </td>
                          );
...

        {
          activeTab === 'attendance' && (
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-gray-600 dark:text-white">Attendance Record</h2>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="card p-6 bg-white dark:bg-black/40 border border-gray-200 dark:border-white/10 shadow-sm dark:shadow-none">
                  <h3 className="text-sm text-gray-500 dark:text-gray-400 mb-2">Total Days</h3>
                  <p className="text-3xl font-bold text-gray-600 dark:text-white">{totalDays}</p>
                </div>
                <div className="card p-6 bg-white dark:bg-black/40 border border-green-500 dark:border-green-600 shadow-sm dark:shadow-none">
                  <h3 className="text-sm text-gray-500 dark:text-gray-400 mb-2">Days Present</h3>
                  <p className="text-3xl font-bold text-green-600 dark:text-green-400">{presentCount}</p>
                </div>
                <div className="card p-6 bg-white dark:bg-black/40 border border-gray-200 dark:border-white/10 shadow-sm dark:shadow-none">
                  <h3 className="text-sm text-gray-500 dark:text-gray-400 mb-2">Attendance %</h3>
                  <p className="text-3xl font-bold text-gray-600 dark:text-white">{attendancePercentage}%</p>
                </div>
              </div>
              ...
              <div className="card overflow-hidden bg-white dark:bg-black/40 border border-gray-200 dark:border-white/10">
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-200 dark:border-gray-700">
                      ...
                      <th className="px-6 py-4 text-center text-sm font-semibold text-gray-600 dark:text-white">Status</th>
                    </tr>
                  </thead>
                ...
                {attendance.length === 0 && (
                  <div className="p-8 text-center text-gray-500 dark:text-gray-400">No attendance records available</div>
                )}
              </div>
            </div>
          )
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {notices.map((notice: any) => (
                  <div key={notice.id} className="card p-6 border-l-4 border-blue-500 bg-white dark:bg-black/40 shadow-sm dark:shadow-none border-y border-r border-gray-200 dark:border-white/10">
          ...
          activeTab === 'complaints' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <h2 className="text-3xl font-bold text-gray-600 dark:text-white">Submit a Complaint</h2>
                <Button
              ...
              <div className="card p-6 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-600">
                <h3 className="text-lg font-semibold text-yellow-800 dark:text-yellow-400 mb-2">📢 Anonymous Submission</h3>
              ...
              <div className="card p-8 text-center bg-white dark:bg-black/40 border border-gray-200 dark:border-white/10">
                <div className="text-6xl mb-4">📝</div>
                <h3 className="text-xl font-semibold text-gray-600 dark:text-white mb-2">Have a concern?</h3>
        ...
        >
          <form onSubmit={handleSubmitComplaint} className="space-y-4">
            <div className="card p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-600">
            ...
            <div>
              <label htmlFor="complaint-title" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Title</label>
              <Input
                id="complaint-title"
                name="title"
                ...
                required
                variant="glass"
                className="bg-white dark:bg-white/10 text-gray-600 dark:text-white border-gray-300 dark:border-gray-600"
              />
            </div>

            <div>
              <label htmlFor="complaint-description" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Description</label>
              <textarea
                ...
                required
                rows={6}
                className="w-full px-4 py-2 rounded-lg bg-white dark:bg-white/10 text-gray-600 dark:text-white border border-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-white focus:outline-none placeholder-gray-400 font-sans"
              />
            </div>
