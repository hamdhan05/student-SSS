  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-bold text-gray-600 dark:text-white">Students</h2>
        <Button
          variant="action"
      ...
      {/* Filters */}
      <div className="card p-6 space-y-4 rounded-xl shadow-sm">
      ...
      {isLoading ? (
        ...
        <>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-700">
                  ...
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-600 dark:text-white">Class</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-600 dark:text-white">Section</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-600 dark:text-white">Guardian</th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-600 dark:text-white">Phone</th>
                  <th className="px-6 py-4 text-right text-sm font-semibold text-gray-600 dark:text-white">Actions</th>
                </tr>
              </thead>
              <tbody>
                {studentsData?.data.map((student) => (
                  <tr key={student.id} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">{student.class}</td>
                    <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">{student.section}</td>
                    <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">{student.guardianName || student.parentName}</td>
                    <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">{student.guardianPhone || student.parentPhone}</td>
          ...
          {/* Pagination */}
          <div className="flex items-center justify-between card p-4 rounded-xl shadow-sm mt-4">
