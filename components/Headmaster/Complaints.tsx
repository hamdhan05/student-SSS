...
export default function Complaints() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-3xl font-bold text-gray-600 dark:text-white">Student Complaints</h2>
      ...
      {isLoading ? (
        ...
        <>
          ...
          {pendingComplaints.length > 0 && (
            <div>
              <h3 className="text-xl font-semibold text-gray-600 dark:text-white mb-4">Pending Complaints</h3>
              <div className="space-y-4">
                {pendingComplaints.map((complaint) => (
                  <div key={complaint.id} className="card p-6 border-yellow-600">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <h4 className="text-lg font-semibold text-gray-600 dark:text-white mb-1">{complaint.title}</h4>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 whitespace-pre-wrap">{complaint.description || complaint.text}</p>
          ...
          {resolvedComplaints.length > 0 && (
            <div className="mt-8">
              <h3 className="text-xl font-semibold text-gray-600 dark:text-white mb-4">Resolved Complaints</h3>
              <div className="space-y-4">
                {resolvedComplaints.map((complaint) => (
                  <div key={complaint.id} className="card p-6 opacity-60">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <h4 className="text-lg font-semibold text-gray-600 dark:text-white mb-1">{complaint.title || complaint.category}</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
