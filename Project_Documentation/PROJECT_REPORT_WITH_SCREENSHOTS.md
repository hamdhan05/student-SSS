...
![Login Page](./screenshots/placeholder.png)
*Note: Screenshot for "Login Page" not captured automatically*
...
![Login Flow](./screenshots/placeholder.png)
*Note: Screenshot for "Login Flow" not captured automatically*
...
![Headmaster Dashboard](./screenshots/placeholder.png)
*Note: Screenshot for "Headmaster Dashboard" not captured automatically*
...
![Students Tab - List View](./screenshots/placeholder.png)
*Note: Screenshot for "Students Tab - List View" not captured automatically*
*Add a screenshot showing the students list with filters*

![Students Tab - Add Student Modal](./screenshots/placeholder.png)
*Note: Screenshot for "Students Tab - Add Student Modal" not captured automatically*
*Add a screenshot of the add student modal form*

![Students Tab - Student Detail View](./screenshots/placeholder.png)
*Note: Screenshot for "Students Tab - Student Detail View" not captured automatically*
*Add a screenshot showing detailed student information*

![Students Tab - Edit Student](./screenshots/placeholder.png)
*Note: Screenshot for "Students Tab - Edit Student" not captured automatically*
...
![Teachers Tab - List View](./screenshots/placeholder.png)
*Note: Screenshot for "Teachers Tab - List View" not captured automatically*
*Add a screenshot showing the teachers list*

![Teachers Tab - Add Teacher Modal](./screenshots/placeholder.png)
*Note: Screenshot for "Teachers Tab - Add Teacher Modal" not captured automatically*
*Add a screenshot of the add teacher form*

![Teachers Tab - Teacher Detail View](./screenshots/placeholder.png)
*Note: Screenshot for "Teachers Tab - Teacher Detail View" not captured automatically*
...
![Notice Board Tab](./screenshots/placeholder.png)
*Note: Screenshot for "Notice Board Tab" not captured automatically*
*Add a screenshot showing the notice board with multiple notices*

![Create Notice Modal](./screenshots/placeholder.png)
*Note: Screenshot for "Create Notice Modal" not captured automatically*
*Add a screenshot of the create/edit notice form*

![Notice Card View](./screenshots/placeholder.png)
*Note: Screenshot for "Notice Card View" not captured automatically*
...
![Calendar Tab - Monthly View](./screenshots/placeholder.png)
*Note: Screenshot for "Calendar Tab - Monthly View" not captured automatically*
*Add a screenshot of the calendar displaying holidays*

![Calendar Tab - Holiday List](./screenshots/placeholder.png)
*Note: Screenshot for "Calendar Tab - Holiday List" not captured automatically*
...
![Fees Tab - Summary Dashboard](./screenshots/placeholder.png)
*Note: Screenshot for "Fees Tab - Summary Dashboard" not captured automatically*
*Add a screenshot showing the fee summary cards (Total, Collected, Pending)*

![Fees Tab - Student Fee List](./screenshots/placeholder.png)
*Note: Screenshot for "Fees Tab - Student Fee List" not captured automatically*
*Add a screenshot of the fee records table with filters*

![Fees Tab - Edit Fee Modal](./screenshots/placeholder.png)
*Note: Screenshot for "Fees Tab - Edit Fee Modal" not captured automatically*
*Add a screenshot of editing a student's fee information*

![Fees Tab - Payment Status](./screenshots/placeholder.png)
*Note: Screenshot for "Fees Tab - Payment Status" not captured automatically*
...
![Complaints Tab - List View](./screenshots/placeholder.png)
*Note: Screenshot for "Complaints Tab - List View" not captured automatically*
*Add a screenshot showing the complaints list*

![Complaints Tab - Complaint Detail](./screenshots/placeholder.png)
*Note: Screenshot for "Complaints Tab - Complaint Detail" not captured automatically*
*Add a screenshot of viewing a specific complaint*

![Complaints Tab - Status Filter](./screenshots/placeholder.png)
*Note: Screenshot for "Complaints Tab - Status Filter" not captured automatically*
...
![Teacher Portal Dashboard](./screenshots/placeholder.png)
*Note: Screenshot for "Teacher Portal Dashboard" not captured automatically*
...
![Teacher Portal - Class Selection](./screenshots/placeholder.png)
*Note: Screenshot for "Teacher Portal - Class Selection" not captured automatically*
*Add a screenshot showing class and section dropdown menus*

![Teacher Portal - Attendance Grid](./screenshots/placeholder.png)
*Note: Screenshot for "Teacher Portal - Attendance Grid" not captured automatically*
*Add a screenshot of the attendance marking interface with student list*

![Teacher Portal - Quick Action Buttons](./screenshots/placeholder.png)
*Note: Screenshot for "Teacher Portal - Quick Action Buttons" not captured automatically*
*Add a screenshot highlighting the "Mark All Present/Absent" buttons*

![Teacher Portal - Individual Student Toggle](./screenshots/placeholder.png)
*Note: Screenshot for "Teacher Portal - Individual Student Toggle" not captured automatically*
*Add a screenshot showing how to toggle individual student attendance*

![Teacher Portal - Submit Confirmation](./screenshots/placeholder.png)
*Note: Screenshot for "Teacher Portal - Submit Confirmation" not captured automatically*
...
![Teacher Portal - Homework Tab](./screenshots/placeholder.png)
*Note: Screenshot for "Teacher Portal - Homework Tab" not captured automatically*
*Add a screenshot of the homework management interface*

![Teacher Portal - Create Homework](./screenshots/placeholder.png)
*Note: Screenshot for "Teacher Portal - Create Homework" not captured automatically*
...
![Teacher Portal - Marks Entry](./screenshots/placeholder.png)
*Note: Screenshot for "Teacher Portal - Marks Entry" not captured automatically*
*Add a screenshot of the marks entry interface*

![Teacher Portal - Marks Table](./screenshots/placeholder.png)
*Note: Screenshot for "Teacher Portal - Marks Table" not captured automatically*
...
![Teacher Portal - Profile Section](./screenshots/placeholder.png)
*Note: Screenshot for "Teacher Portal - Profile Section" not captured automatically*
...
![Student Portal Dashboard](./screenshots/placeholder.png)
*Note: Screenshot for "Student Portal Dashboard" not captured automatically*
...
![Student Portal - Academics Tab](./screenshots/placeholder.png)
*Note: Screenshot for "Student Portal - Academics Tab" not captured automatically*
*Add a screenshot showing test scores and performance*

![Student Portal - Subject-wise Marks](./screenshots/placeholder.png)
*Note: Screenshot for "Student Portal - Subject-wise Marks" not captured automatically*
...
![Student Portal - Timetable Tab](./screenshots/placeholder.png)
*Note: Screenshot for "Student Portal - Timetable Tab" not captured automatically*
...
![Student Portal - Homework Tab](./screenshots/placeholder.png)
*Note: Screenshot for "Student Portal - Homework Tab" not captured automatically*
*Add a screenshot showing homework assignments*

![Student Portal - Homework Details](./screenshots/placeholder.png)
*Note: Screenshot for "Student Portal - Homework Details" not captured automatically*
...
![Student Portal - Attendance Tab](./screenshots/placeholder.png)
*Note: Screenshot for "Student Portal - Attendance Tab" not captured automatically*
*Add a screenshot showing attendance records and percentage*

![Student Portal - Attendance Percentage Card](./screenshots/placeholder.png)
*Note: Screenshot for "Student Portal - Attendance Percentage Card" not captured automatically*
*Add a screenshot highlighting the attendance percentage display*

![Student Portal - Attendance Calendar View](./screenshots/placeholder.png)
*Note: Screenshot for "Student Portal - Attendance Calendar View" not captured automatically*
...
![Student Portal - Notices Tab](./screenshots/placeholder.png)
*Note: Screenshot for "Student Portal - Notices Tab" not captured automatically*
...
![Student Portal - Complaints Tab](./screenshots/placeholder.png)
*Note: Screenshot for "Student Portal - Complaints Tab" not captured automatically*
*Add a screenshot of the complaint submission form*

![Student Portal - Complaint Form Fields](./screenshots/placeholder.png)
*Note: Screenshot for "Student Portal - Complaint Form Fields" not captured automatically*
*Add a screenshot showing the form with title and description fields*

![Student Portal - Submit Button](./screenshots/placeholder.png)
*Note: Screenshot for "Student Portal - Submit Button" not captured automatically*
*Add a screenshot highlighting the submit button*

![Student Portal - Success Message](./screenshots/placeholder.png)
*Note: Screenshot for "Student Portal - Success Message" not captured automatically*
...
![Student Portal - Profile Sidebar](./screenshots/placeholder.png)
*Note: Screenshot for "Student Portal - Profile Sidebar" not captured automatically*
...
![Design System Overview](./screenshots/placeholder.png)
*Note: Screenshot for "Design System Overview" not captured automatically*
...
![Button Variants](./screenshots/placeholder.png)
*Note: Screenshot for "Button Variants" not captured automatically*
...
![Input Field Variants](./screenshots/placeholder.png)
*Note: Screenshot for "Input Field Variants" not captured automatically*
...
![Card Components](./screenshots/placeholder.png)
*Note: Screenshot for "Card Components" not captured automatically*
...
![Modal Examples](./screenshots/placeholder.png)
*Note: Screenshot for "Modal Examples" not captured automatically*
...
![Responsive Views](./screenshots/placeholder.png)
*Note: Screenshot for "Responsive Views" not captured automatically*
